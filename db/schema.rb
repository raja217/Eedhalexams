...
ActiveRecord::Schema.define(:version => 20131205172234) do
  ...
  create_table "exam_groups", :force => true do |t|
    ...
    t.boolean "result_published",           :default => false
    t.date    "exam_date"
    t.integer "student_aditional_field_id"
  ...
  add_index "exam_scores", ["student_id", "exam_group_id"], :name => "index_exam_scores_on_student_id_and_exam_group_id", :limit => {"student_id"=>nil, "exam_group_id"=>nil}
